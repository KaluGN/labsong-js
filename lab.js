...
fetch(
  ...
  "http://ws.audioscrobbler.com/2.0/?method=geo.gettopartists&country=spain&api_key=71c6e93a483131a54868320696adb1c7&format=json&limit=5"
)
  ...
  .then(function(myJson) {
    ...
    const el = myJson.topartists.artist;
